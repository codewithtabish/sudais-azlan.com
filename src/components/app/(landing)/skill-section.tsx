  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "relative flex items-center justify-center w-full  h-[320px] md:h-[450px] perspective-[1200px] select-none overflow-visible",
          className
        )}
        {...props}
      >
          <div
        className="pointer-events-none absolute inset-0 opacity-[0.35] [background-image:radial-gradient(currentColor_1px,transparent_1px)] [background-size:22px_22px] text-muted-foreground/30"
        aria-hidden
      />
        {/* 
          ======================================================================
